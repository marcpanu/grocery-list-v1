...
import UnitPreferences from './settings/UnitPreferences';
import { getUserData, addStoredCredential, deleteStoredCredential, deleteAllImages, getUserPreferences, updateUserPreferences } from '../firebase/firestore';
import { formatBytes } from '../utils/format';
import { UserData, StoredCredential, UserPreferences } from '../types';

type SettingsSection = 'main' | 'stores' | 'categories' | 'data' | 'pantry' | 'units';
        ...
        <div>
          ...
          <div className="bg-white rounded-lg shadow-sm divide-y divide-zinc-200">
            ...
            <SettingsMenuItem
              ...
              description="Configure mass and volume units for your grocery list"
